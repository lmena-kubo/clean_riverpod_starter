...
mixin _$AuthResponseDto {
 ...
 UserDto get user; SessionDto get session;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthResponseDto&&(identical(other.user, user) || other.user == user)&&(identical(other.session, session) || other.session == session));
}
...
@override
String toString() {
  return 'AuthResponseDto(user: $user, session: $session)';
}
...
@useResult
$Res call({
 UserDto user, SessionDto session
});


$UserDtoCopyWith<$Res> get user;$SessionDtoCopyWith<$Res> get session;
...
as UserDto,session: null == session ? _self.session : session // ignore: cast_nullable_to_non_nullable
as SessionDto,
  ));
}
/// Create a copy of AuthResponseDto
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( UserDto user,  SessionDto session)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponseDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( UserDto user,  SessionDto session)  $default,) {final _that = this;
switch (_that) {
case _AuthResponseDto():
return $default(_that.user,_that.session);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( UserDto user,  SessionDto session)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponseDto() when $default != null:
return $default(_that.user,_that.session);case _:
  return null;
...
class _AuthResponseDto implements AuthResponseDto {
  const _AuthResponseDto({required this.user, required this.session});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthResponseDto&&(identical(other.user, user) || other.user == user)&&(identical(other.session, session) || other.session == session));
}
...
@override $UserDtoCopyWith<$Res> get user;@override $SessionDtoCopyWith<$Res> get session;
